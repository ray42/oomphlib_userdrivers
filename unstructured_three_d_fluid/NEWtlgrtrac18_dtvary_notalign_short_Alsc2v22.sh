...
DT="--dt 0.1"
TIMEPARAM="${DO_UNSTEADY} ${TSTART} ${TEND} ${DT} ${DO_ADAPTTIME} ${TIMETOL}"
PARAM2="${PARAM} ${TETGENNUM} ${DOCNUM} ${TIMEPARAM}"
...
#  cd ${SCRATCH_TEST_DIR} 
#  mkdir RESLT
#  ln -s /mnt/iusers01/mh01/mbax5ml3/trunk_optimized/user_drivers/unstructured_three_d_fluid/tetgen_notaligned_short tetgen_notaligned_short
#
#fi
